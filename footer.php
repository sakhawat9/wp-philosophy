    ...
    <div class="s-footer__main">
        <div class="row">
            ...
            <div class="col-five md-full end s-footer__subscribe">
                ...
                $options = get_option('philosophy_option');

                $philosophy_social_facebook = $options['social_facebook'];
                if ($philosophy_social_facebook) {
                    echo "<a target='_blank' href='" . esc_url($philosophy_social_facebook) . "'><i class='fa fa-facebook'></i></a>";
                }

                $philosophy_social_twitter = $options['social_twitter'];
                if ($philosophy_social_twitter) {
                    echo "<a target='_blank' href='" . esc_url($philosophy_social_twitter) . "'><i class='fa fa-twitter'></i></a>";
                }
                $philosophy_social_twitter = $options['social_pinterest'];
                if ($philosophy_social_twitter) {
                    echo "<a target='_blank' href='" . esc_url($philosophy_social_twitter) . "'><i class='fa fa-pinterest'></i></a>";
                }
