    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        ...
        <article class="row format-standard">
            ...
            <div class="col-full s-content__main">
                ...
                echo $meta['page-upload'];
                echo "<br/>";
                
                // echo $meta['page-image'];
                echo wp_get_attachment_image($meta['page-image'],'medium');
                echo $meta['page-gallery'];
                if($meta['page-gallery']){
                    $philosophy_gallery_ids = explode(",",$meta['page-gallery']);
