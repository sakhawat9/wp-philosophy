        ...
        <div class="col-full s-content__main">
            ...
            if ($group_data) {
                foreach ($group_data as $gd) {
                    ...
                    echo "<br/>";
                    echo "<img src=". esc_url($gd['image_data']) ." alt=''  />";
                    echo "<br/>";
            ...
            $option = get_option('philosophy_option');
            $theme_option_group_data = $option['group_field'];
            // echo "<pre>";
            ...
            foreach($theme_option_group_data as $togd){
                ...
                echo "<br/>";
                echo "<img src=". esc_url($togd['image_data']) ." alt=''  />";
                echo "<hr/>";
            }
            ...
            echo "<br/>";
            echo "<img src=". esc_url($theme_option_group_data[1]['image_data']) ." alt=''  />";;
            echo "<br/>";
